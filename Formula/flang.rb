...
class Flang < Formula
  ...
  url "https://github.com/digitable-lol/flang/releases/download/v0.4.1/flang-0.4.1-c.tar.gz"
  ...
  sha256 "91bbdcf5bff13a1a6bd76047e0cd9539bd8e092e7019fa681a5762fc77ca81cc"
